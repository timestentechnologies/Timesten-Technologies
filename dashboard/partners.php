                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="createpartner" class="btn btn-primary btn-sm"><i class="ri-add-line"></i> Add Partner</a>
                                </div>
                                <div class="card-body">
                                    <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                        ...
                                        <?php
                                           $q="SELECT * FROM partners ORDER BY sort_order ASC, id DESC";
                                           ...
                                           while($ro = mysqli_fetch_array($r123))
                                           {
                                                ...
                                                $logo_html = $logo ? "<img src='uploads/partners/$logo' alt='logo' style='max-height:60px; max-width:120px;'>" : "<span class='text-muted'>No logo</span>";
                                                    ...
                                                    <td>
                                                        <div class='dropdown d-inline-block'>
                                                            ...
                                                            <ul class='dropdown-menu dropdown-menu-end'>
                                                                <li>
                                                                    <a href='edit-partner.php?id=$id' class='dropdown-item'>
