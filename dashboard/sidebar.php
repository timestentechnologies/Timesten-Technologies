  ...
  <div id="scrollbar">
    <div class="container-fluid">
      ...
      <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="menu-title"><span data-key="t-website">Manage Website Pages</span></li>
        <li class="nav-item">
              ...
              <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarPartners" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarPartners">
                                <i class="ri-team-line"></i> <span data-key="t-landing">Manage Partners</span>
                            </a>
   ...
   <li class="menu-title"><span data-key="t-management">ACCOUNTING</span></li>
        ...
        <li class="menu-title"><span data-key="t-system">System Settings</span></li>
        <li class="nav-item">
