...
--
-- Host: localhost    Database: opulentl_timestentech
-- ------------------------------------------------------
...
(1,'backup_2026-03-18_07-20-49.sql','/home3/opulentl/timestentechnologies.co.ke/dashboard/backups/backup_2026-03-18_07-20-49.sql',428394,'2026-03-18 07:20:49','timestentechnologies@gmail.com','manual','success'),
(2,'backup_2026-03-26_15-17-40.sql','/home3/opulentl/timestentechnologies.co.ke/dashboard/backups/backup_2026-03-26_15-17-40.sql',528556,'2026-03-26 15:17:40','timestentechnologies@gmail.com','manual','success'),
(3,'backup_2026-04-09_09-16-37.sql','/home3/opulentl/timestentechnologies.co.ke/dashboard/backups/backup_2026-04-09_09-16-37.sql',644860,'2026-04-09 09:16:37','timestentechnologies@gmail.com','manual','success');
...
LOCK TABLES `chat_responses` WRITE;
/*!40000 ALTER TABLE `chat_responses` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `chat_responses` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `doc_access_tokens`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `doc_access_tokens` WRITE;
/*!40000 ALTER TABLE `doc_access_tokens` DISABLE KEYS */;
INSERT INTO `doc_access_tokens` VALUES
...
/*!40000 ALTER TABLE `doc_access_tokens` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `employee_payment_deductions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `employee_payment_deductions`
--

LOCK TABLES `employee_payment_deductions` WRITE;
/*!40000 ALTER TABLE `employee_payment_deductions` DISABLE KEYS */;
/*!40000 ALTER TABLE `employee_payment_deductions` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `enquiry_text` VALUES
...
LOCK TABLES `finance_customers` WRITE;
/*!40000 ALTER TABLE `finance_customers` DISABLE KEYS */;
INSERT INTO `finance_customers` VALUES
(3,'SwimG\'s Academy','','0791539635','Web Development','Nairobi, Kenya','2026-03-26 11:57:43');
/*!40000 ALTER TABLE `finance_customers` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `finance_expense_categories` WRITE;
/*!40000 ALTER TABLE `finance_expense_categories` DISABLE KEYS */;
INSERT INTO `finance_expense_categories` VALUES
...
/*!40000 ALTER TABLE `finance_expense_categories` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `finance_invoice_items` VALUES
...
(7,3,5,'Design and Artwork',1.00,1000.00,1000.00,'2026-04-09 12:18:11');
...
INSERT INTO `finance_invoices` VALUES
(3,'INV-20260326-9635',3,'2026-03-26','2026-03-26','paid','Web Development \r\nDeployment and Hosting\r\nVideo Design',27200.00,NULL,NULL,27200.00,27200.00,'2026-03-26 12:03:24');
...
LOCK TABLES `finance_products` WRITE;
/*!40000 ALTER TABLE `finance_products` DISABLE KEYS */;
INSERT INTO `finance_products` VALUES
(1,'Website development','',20000.00,1,'2026-02-24 12:28:24'),
(2,'software installation','',20000.00,1,'2026-02-24 20:06:28'),
(3,'Hosting and Deployment','',4200.00,1,'2026-03-26 12:05:04'),
(4,'Domain','',1500.00,1,'2026-03-26 12:06:17'),
(5,'Design Work','',1000.00,1,'2026-04-09 12:18:11');
/*!40000 ALTER TABLE `finance_products` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `job_application_answers` (
  ...
  CONSTRAINT `fk_answers_application` FOREIGN KEY (`application_id`) REFERENCES `job_applications` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_answers_question` FOREIGN KEY (`question_id`) REFERENCES `job_questions` (`id`) ON DELETE CASCADE
...
INSERT INTO `job_questions` VALUES
...
CREATE TABLE `page_visits` (
  ...
  `created_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_page_visits_created_at` (`created_at`),
  KEY `idx_page_visits_page_url` (`page_url`),
  KEY `idx_page_visits_device_type` (`device_type`),
  KEY `idx_page_visits_ip_address` (`ip_address`)
) ENGINE=InnoDB AUTO_INCREMENT=2476 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `portfolio_media` (
  ...
  `created_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_portfolio_media_portfolio_id` (`portfolio_id`)
...
LOCK TABLES `portfolio_media` WRITE;
/*!40000 ALTER TABLE `portfolio_media` DISABLE KEYS */;
INSERT INTO `portfolio_media` VALUES
...
/*!40000 ALTER TABLE `portfolio_media` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `section_title`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `section_title` WRITE;
/*!40000 ALTER TABLE `section_title` DISABLE KEYS */;
INSERT INTO `section_title` VALUES
...
/*!40000 ALTER TABLE `section_title` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `service_media` (
  ...
  `created_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_service_media_service_id` (`service_id`)
...
INSERT INTO `service_media` VALUES
...
DROP TABLE IF EXISTS `service_text`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `service_text` WRITE;
/*!40000 ALTER TABLE `service_text` DISABLE KEYS */;
INSERT INTO `service_text` VALUES
(1,'Service Text Title','Service text content here...');
/*!40000 ALTER TABLE `service_text` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `sitecontact` WRITE;
/*!40000 ALTER TABLE `sitecontact` DISABLE KEYS */;
INSERT INTO `sitecontact` VALUES
...
/*!40000 ALTER TABLE `sitecontact` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `why_us` WRITE;
/*!40000 ALTER TABLE `why_us` DISABLE KEYS */;
INSERT INTO `why_us` VALUES
...
/*!40000 ALTER TABLE `why_us` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-04-09 15:10:10
