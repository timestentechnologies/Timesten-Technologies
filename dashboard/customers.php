...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_customer'])) {
    ...
    mysqli_query($con, "INSERT INTO finance_customers (name, email, phone, address, created_at) VALUES ('$name_s', '$email_s', '$phone_s', '$address_s', NOW())");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_customer'])) {
    ...
    mysqli_query($con, "UPDATE finance_customers SET name='$name_s', email='$email_s', phone='$phone_s', address='$address_s' WHERE id=$id LIMIT 1");
            ...
            <table class="table table-striped align-middle mb-0">
              ...
              <tbody>
                ...
                if (count($customers) < 1) {
                    print "<tr><td colspan='5' class='text-center text-muted'>No customers yet.</td></tr>";
                }
                foreach ($customers as $c) {
                    ...
                    print "<tr>";
                    print "<td>$nm</td><td>$em</td><td>$ph</td><td>$dt</td>";
                    print "<td class='text-end'>";
                    print "<button type='button' class='btn btn-sm btn-soft-secondary js-cust-edit' data-id='$id' data-name='$nm' data-email='$em' data-phone='$ph' data-address='$ad'>Edit</button> ";
