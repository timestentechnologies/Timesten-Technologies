...
if (isset($_POST['save'])) {
    ...
    if ($status == "OK") {
        $qb = mysqli_query($con, "INSERT INTO partners (name, website_url, logo, is_active, sort_order) VALUES ('$name', '$website_url', '$logo_file', '$is_active', '$sort_order')");
        if ($qb) {
            $errormsg = "<div class='alert alert-success alert-dismissible fade show'>Partner added successfully.<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>";
        } else {
                            ...
                            <div class="card mt-xxl-n5">
                                ...
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" name="save" class="btn btn-primary">Save Partner</button>
